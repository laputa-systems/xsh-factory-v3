Complete the XSH product investigation assignment ${ASSIGNMENT_ID}.
...
Submit no more than three proposals. Use the admitted `reproducer` command profile and a sealed XSH
