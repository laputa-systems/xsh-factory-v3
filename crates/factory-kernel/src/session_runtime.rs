    ...
    V: SessionRuntimeVerifier,
{
    ...
    let admitted_wire = factory_protocol::verify_assignment_packet_v2(
        &request.canonical_packet_bytes,
...
mod tests {
    use super::*;
    use factory_protocol::{
        AbsoluteHostPath, AggregateRevision, AssignmentRole, DurationMillis, MicroUsd,
        ModelProfileV2, PolicyEntrypointV2, RepositoryRelativePath, RuntimeIdentityV2,
        SessionLimitsV2, ThinkingLevelV2,
    };

    fn packet() -> AssignmentPacketV2 {
        AssignmentPacketV2 {
            ...
            policy_digest: ContentDigest::of_bytes(b"return {}"),
            policy_byte_limit: 64,
            policy_bytes: b"return {}".to_vec(),
            ...
            runtime: RuntimeIdentityV2 {
                ...
                credential_env: "OPENROUTER_API_KEY".to_owned(),
            },
            required_reads: vec![factory_protocol::ReadExactFileV2 {
                path: RepositoryRelativePath::parse("AGENTS.md").unwrap(),
                digest: ContentDigest::of_bytes(b"read"),
                reason: "test".to_owned(),
            }],
            assignment_evidence: vec![factory_protocol::AssignmentEvidenceV2 {
                role: factory_protocol::AssignmentEvidenceRoleV2::TicketProposal,
