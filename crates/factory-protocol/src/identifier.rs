...
numeric_identifier!(ProjectId, "project ID");
numeric_identifier!(RfcId, "RFC ID");
numeric_identifier!(RfcRevisionId, "RFC revision ID");
numeric_identifier!(ExperimentId, "experiment ID");
numeric_identifier!(ExperimentRunId, "experiment run ID");
